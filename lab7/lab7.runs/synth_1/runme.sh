...
HD_PWD='C:/Users/Morris/Documents/Fall 21/ECE 524/lab/lab7/lab7/lab7.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log fir_serial.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source fir_serial.tcl
